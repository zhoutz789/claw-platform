 ...
 */
const resources = {
  zh: { common: zhCommon, nav: zhNav, system: zhSystem },
  en: { common: enCommon, nav: enNav, system: enSystem },
  km: { common: kmCommon, nav: kmNav, system: kmSystem },
};
