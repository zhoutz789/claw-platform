 ...
 */
const resources = {
  zh: { common: zhCommon, nav: zhNav, system: zhSystem, supply: zhSupply },
  en: { common: enCommon, nav: enNav, system: enSystem, supply: enSupply },
  km: { common: kmCommon, nav: kmNav, system: kmSystem, supply: kmSupply },
};
